...
#'
#' A [SMARTR::mouse] object is an object that will store multiple slice objects (and therefore all the information in it),
...
#' An [SMARTR::experiment]An experiment object consists of a list of processed mouse objects with raw data from slices omitted, and experimental attributes stored as a list.
