...
```{r}
mouse_325 <- normalize_cell_counts(mouse_325, combine_hemispheres = FALSE, simplify_regions = FALSE)
...
mouse_325 <- SMARTR::split_hipp_DV(mouse_325, AP_coord = -2.7, combine_hemispheres = FALSE)
