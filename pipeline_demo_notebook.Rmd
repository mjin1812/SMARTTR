...
for (k in 1:10){
  ...
  m1 <- normalize_cell_counts(m1, combine_hemispheres = TRUE, simplify_regions = TRUE)
  m1 <- split_hipp_DV(m1, AP_coord = -2.7, combine_hemispheres = TRUE, simplify_regions = TRUE, merge = TRUE)
  sundowning <- add_mouse(sundowning, m1)
}
