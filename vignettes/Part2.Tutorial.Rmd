...
Therefore, if you are processing any z-stack images, they need to be flattened and channels need to be collapsed into a single image used for the purpose of registration. This step needs to be completed prior to using SMARTR for registration. We detail how to do this in using our pre-processing [article](/articles/Part1.Segmentation.html)
...
This concludes the end of the mapping tutorial! Check out section [4. Example analysis notebook ](../articles/Part4.Example_Analysis_Notebook.html) to see how we apply the analysis and visualization functions in SMARTR to this dataset. 
