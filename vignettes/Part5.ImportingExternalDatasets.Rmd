...
* `normalized.counts.by.volume` - the `counts` column divided by the `volume.mm3` column.
...
# If you have more than one channel data set to import, you would specify the normalized_count_paths as a vector of named strings, with the names corresponding to the channel names.
